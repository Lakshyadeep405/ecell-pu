      ...
      <div className="pb-6 border-b-2 border-border flex items-center justify-between">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-xs font-semibold">
            Define basic event details and construct custom registration forms.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1.5 md:col-span-2">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-background border-2 border-border text-foreground font-semibold focus:outline-none focus:border-[#D4AF37] text-sm rounded-none resize-none"
              />
            </div>
            ...
            {/* Banner banner upload + direct url */}
        ...
        <div className="bg-card border-2 border-border p-6 shadow-[3px_3px_0px_#D4AF37] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          >
            ...
            {loading ? "Constructing Event Form..." : "Create Event & Form"}
          </button>
        </div>
      </form>
    </div>
