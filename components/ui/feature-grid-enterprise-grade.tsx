      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {(sectionTitle || sectionSubtitle) && (
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
            {sectionTitle && (
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground font-[family-name:var(--font-outfit)]">
                {sectionTitle}
              </h2>
            )}
            {sectionSubtitle && (
          ...
          {features.map((feature) => (
            ...
            >
              <CardHeader className="p-0 pb-3">
                ...
                <CardTitle className="text-xl font-semibold text-foreground font-[family-name:var(--font-outfit)]">
                  {feature.title}
                </CardTitle>
              </CardHeader>
